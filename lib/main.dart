              ...
              children: <Widget>[
                ...
                Stack(
                  children: [
                    ...
                    SemiCircleWidget(
                      diameter: 200,
                      percent: ((50 - 15) * 12.0).clamp(0.0, percent),
                      color: Colors.red,
                    ),
                  ],
                ),
...
class SemiCircleWidget extends StatefulWidget {
  ...
  @override
  State<SemiCircleWidget> createState() => _SemiCircleWidgetState();
}

class _SemiCircleWidgetState extends State<SemiCircleWidget> {
  double sweepAngle = 0;
  @override
  void initState() {
    Timer? timer;
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        CustomPaint(
          painter: MyIndicator((sweepAngle / 24) * 180, widget.color),
